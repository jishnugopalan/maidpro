...
// echo $sql;
$sql2="insert into request(userid,workerid,needs,contact_address,contact_number,booking_date)values('$user_email','$worker_email','$needs','$contact_address',$contact_number,'$booking_date')";
