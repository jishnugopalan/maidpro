    <div class="sidebar-menu">
		    ...
		    <div class="menu">
		      <ul id="menu" >
		        ...
		        <li id="menu-home" ><a href="addcategory.php"><i class="fa fa-plus-circle"></i><span>Update Category</span></a></li>
		        <li id="menu-home" ><a href="viewworkers.php"><i class="fa fa-check"></i><span>Approve Workers</span></a></li>
		        <li id="menu-home" ><a href="viewcontents.php"><i class="fa fa-user"></i><span>View Details</span></a></li>
